  ...
  return (
    ...
    >
      <div className="relative h-14 w-14 shrink-0">
        ...
        {isAvailable && (
          <span className="absolute bottom-0 right-0 h-4 w-4 bg-green-500 rounded-full border-2 border-white dark:border-stone-900" />
        )}
      </div>
      <div className="text-gray-600 min-w-0 flex-1 dark:text-stone-300">
        <h3 className={`flex items-center gap-2 ${unread ? "font-bold text-gray-900 dark:text-white" : "font-semibold"}`}>
